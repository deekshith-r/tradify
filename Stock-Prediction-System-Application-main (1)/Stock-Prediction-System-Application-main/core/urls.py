...
from app.views import index, search, predict, ticker, developer_info_view,Terms_of_service,privacy_policy,result_view   # Import the views
...
urlpatterns = [
    ...
    path('privacy/',privacy_policy,name="privacy_info")
]
